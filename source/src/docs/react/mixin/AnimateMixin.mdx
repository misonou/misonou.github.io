...
<ImportHint
    name="useAnimateMixin"
    module="brew-js-react"
    require="useAnimateMixin"
    global="brew.react.useAnimateMixin"
/>
...
<ImportHint
    name="AnimateMixin"
    module="brew-js-react"
    require="AnimateMixin"
    global="brew.react.AnimateMixin"
    expanded
/>
...
<MemberList
    ...
    extendsTo={['AnimateSequenceMixin']}
    im={['with()', 'withEffects()']}
/>
