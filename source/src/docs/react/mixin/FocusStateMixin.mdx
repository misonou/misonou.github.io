...
<ImportHint
    name="useFocusStateMixin"
    module="brew-js-react"
    require="useFocusStateMixin"
    global="brew.react.useFocusStateMixin"
/>
...
<ImportHint
    name="FocusStateMixin"
    module="brew-js-react"
    require="FocusStateMixin"
    global="brew.react.FocusStateMixin"
    expanded
/>
