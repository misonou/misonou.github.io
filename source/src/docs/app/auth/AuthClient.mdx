...
<dl>
    ...
    <dl>
        #### `interaction` <Badge.ReadOnly /> <Badge.Deprecated />
        ...
        > Use [`AuthProviderContext.interaction`](:) instead.
...
<dl>
    ...
    <dl>
        ...
        #### `singleLogout` <Badge.ReadOnly />  <Badge.Deprecated />
...
<dl>
    ...
    > Before 0.6.0, this argument is contains `accountId`, `interaction` and `singleLogout` properties.
...
- **0.7.0** `AuthClient.login()`: `passkey` options
</VersionTimeline>
