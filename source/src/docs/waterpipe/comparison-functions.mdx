...
> **Note**
  In constrast to the native comparison operator, `undefined` and `null` are always less than any other values; and arrays are compared element by element recursively.
